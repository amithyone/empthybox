...
<body class="bg-dark-100 text-gray-200 min-h-screen font-sans">
            ...
            <div class="flex justify-between items-center h-14 md:h-16">
                ...
                <div class="flex items-center gap-2 md:gap-4 text-sm md:text-base">
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(route('products.index')); ?>" class="hidden sm:inline-block px-2 md:px-3 py-1.5 rounded-md hover:bg-dark-300 transition <?php echo e(request()->routeIs('products.*') ? 'text-yellow-accent border-b border-yellow-accent' : ''); ?>">Products</a>
    ...
    <nav class="fixed bottom-0 left-0 right-0 bg-dark-200 border-t border-red-accent/30 z-50 md:hidden backdrop-blur-sm shadow-2xl">
        <div class="flex justify-around items-center h-16 px-1">
            ...
            <a href="<?php echo e(route('products.index')); ?>" class="flex flex-col items-center justify-center flex-1 h-full <?php echo e(request()->routeIs('products.*') ? 'text-yellow-accent' : 'text-gray-400'); ?> transition">
...
<?php /**PATH /var/www/biggestlogs/resources/views/layouts/app.blade.php ENDPATH**/ ?>