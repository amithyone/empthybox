...
@section('content')
<div class="max-w-4xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 pt-16 md:pt-20 mt-[100px] pb-20 md:pb-8" style="margin-top: 100px;">
    ...
    <div class="bg-dark-200 border-2 border-dark-300 rounded-xl shadow-lg p-4 md:p-6 mb-6 md:mb-8">
        ...
        <form id="deposit-form">
            ...
            <div class="mb-4">
                ...
                @if(isset($paymentGateways) && $paymentGateways->isEmpty())
                    <p class="text-yellow-accent text-xs mt-2">No payment gateways configured. Please contact admin.</p>
                @endif
            </div>
            <button type="submit" 
